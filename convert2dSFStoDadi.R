...
# script written by Jacob Crawford                                                                     

# at this moment, it should be used only with unfolded data since ngs2dSFS doesn't work with folded files; in that case I suggest to fold it using dadi utilities
