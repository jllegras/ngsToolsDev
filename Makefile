...
all: mkdir ngsCovar ngsSim ngs2dSFS ngsFST GetSubSfs GetSubSim GetSubGeno GetSwitchedGeno GetMergedGeno GetSwitchedSfs ngsStat
...
ngsStat: ngsStat.cpp
	$(CC) ngsStat.cpp -o bin/ngsStat $(CFLAGS)
...
GetSwitchedSfs: GetSwitchedSfs.cpp
	$(CC) GetSwitchedSfs.cpp -o bin/GetSwitchedSfs

GetMergedGeno: GetMergedGeno.cpp
	$(CC) GetMergedGeno.cpp -o bin/GetMergedGeno

clean:
	rm -rf *o bin/ngsFST bin/ngsCovar bin/ngsSim bin/ngs2dSFS bin/GetSubSfs bin/GetSubSim bin/GetSubGeno bin/GetSwitchedGeno bin/GetMergedGeno bin/GetSwitchedSfs bin/ngsStat
