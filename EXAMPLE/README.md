...
These are several examples on how to generate and analyse NGS data using ngsTools. For your convenience, all files generated by these example are provided in this folder (data.tar.gz). To recreate your own files, you can work in a different folder.
